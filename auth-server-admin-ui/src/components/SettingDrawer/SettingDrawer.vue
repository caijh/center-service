            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  ...
                  <a-select :defaultValue="contentWidth" size="small" style="width: 80px;"
              ...
              <a-list-item>
                <a-switch slot="actions" :defaultChecked="autoHideHeader" :disabled="!fixedHeader" size="small"
              ...
              <a-list-item>
                <a-switch slot="actions" :defaultChecked="fixSiderbar" :disabled="(layoutMode === 'topmenu')"
                          size="small" @change="handleFixSiderbar"/>
                <a-list-item-meta>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div>
            <a-list :split="false">
              ...
              <a-list-item>
                <a-switch slot="actions" :defaultChecked="multiTab" size="small" @change="onMultiTab"/>
                <a-list-item-meta>
