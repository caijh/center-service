<template>
  <a-card :bordered="false" :style="{ height: '100%' }">
    <a-row :gutter="24">
      <a-col :md="4">
        <a-list :dataSource="roles" itemLayout="vertical">
            ...
            <a-form-item label="拥有权限">
              <a-row v-for="(permission, index) in permissions" :key="index" :gutter="16">
                ...
                <a-col :lg="24" :xl="20">
                  ...
                  <a-checkbox-group v-model="permission.selected" :options="permission.actionsOptions"
...
import {getPermissions, getRoleList} from '@/api/manage'
