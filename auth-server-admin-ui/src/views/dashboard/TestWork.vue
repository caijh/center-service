<template>
  <div>
    ...
    <div class="multi-tab-test">
      ...
      <a-popconfirm :visible="visible" cancelText="取消" okText="确定" @cancel="cancel" @confirm="confirm">
      ...
      <a-popconfirm :visible="visible2" cancelText="取消" okText="确定" @cancel="() => visible2 = false"
                    @confirm="confirm2">
        <template v-slot:title>
          <div>
