<template>
  <div>
    <a-row :gutter="24">
      ...
      <a-col :md="12" :sm="24" :style="{ marginBottom: '24px' }" :xl="6">
        <chart-card :loading="loading" :total="8846 | NumberFormat" title="访问量">
          <a-tooltip slot="action" title="指标说明">
            <a-icon type="info-circle-o"/>
          </a-tooltip>
          <div>
      ...
      <a-col :md="12" :sm="24" :style="{ marginBottom: '24px' }" :xl="6">
        <chart-card :loading="loading" title="运营活动效果" total="78%">
          ...
          <div>
            <mini-progress :percentage="78" :target="80" color="rgb(19, 194, 194)" height="8px"/>
          </div>
    ...
    <div :class="!isMobile && 'desktop'" class="antd-pro-pages-dashboard-analysis-twoColLayout">
      <a-row :gutter="24" :style="{ marginTop: '24px' }" type="flex">
        <a-col :lg="24" :md="24" :sm="24" :xl="12" :xs="24">
          <a-card :bordered="false" :loading="loading" :style="{ height: '100%' }" title="线上热门搜索">
            ...
            <a-row :gutter="68">
              <a-col :sm="12" :style="{ marginBottom: ' 24px'}" :xs="24">
                <number-info :sub-total="17.1" :total="12321">
                  <span slot="subtitle">
                    <span>搜索用户数</span>
                    <a-tooltip slot="action" title="指标说明">
              ...
              <a-col :sm="12" :style="{ marginBottom: ' 24px'}" :xs="24">
                <number-info :sub-total="26.2" :total="2.7" status="down">
                  <span slot="subtitle">
                    <span>人均搜索次数</span>
                    <a-tooltip slot="action" title="指标说明">
                      <a-icon :style="{ marginLeft: '8px' }" type="info-circle-o"/>
        ...
        <a-col :lg="24" :md="24" :sm="24" :xl="12" :xs="24">
          <a-card :bordered="false" :loading="loading" :style="{ height: '100%' }"
                  class="antd-pro-pages-dashboard-analysis-salesCard" title="销售额类别占比">
