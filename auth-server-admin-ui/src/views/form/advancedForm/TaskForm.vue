  ...
  <a-form :form="form" class="form" @submit="handleSubmit">
    <a-row :gutter="16" class="form-row">
      <a-col :lg="6" :md="12" :sm="24">
        <a-form-item
          label="任务名">
          <a-input v-decorator="[ 'name2', {rules: [{ required: true, message: '请输入任务名称', whitespace: true}]} ]"
                   placeholder="请输入任务名称"/>
        </a-form-item>
      </a-col>
      <a-col :lg="{span: 8}" :md="{span: 12}" :sm="24" :xl="{span: 7, offset: 1}">
        <a-form-item
          label="任务描述">
          <a-input v-decorator="[ 'url2', {rules: [{ required: true, message: '请输入任务描述', whitespace: true}]} ]"
                   placeholder="请输入任务描述"/>
        </a-form-item>
      </a-col>
