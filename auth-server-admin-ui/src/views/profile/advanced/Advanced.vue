  ...
  >
      ...
      <a-steps :current="1" :direction="isMobile && 'vertical' || 'horizontal'" progressDot>
        <a-step>
          ...
          <template v-slot:description>
            <div class="antd-pro-pages-profile-advanced-style-stepDescription">
              曲丽丽
              <a-icon style="margin-left: 8px;" type="dingding"/>
        ...
        <a-step>
          ...
          <template v-slot:description>
            <div class="antd-pro-pages-profile-advanced-style-stepDescription">
              周毛毛
              <a-icon style="color: rgb(0, 160, 233); margin-left: 8px;" type="dingding"/>
              <div><a>催一下</a></div>
            </div>
          </template>
        </a-step>
    ...
    <a-card :bordered="false" style="margin-top: 24px" title="用户信息">
      ...
      <a-card title="多层信息组" type="inner">
        <a-descriptions size="small" title="组名称">
